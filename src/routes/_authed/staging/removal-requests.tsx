 ...
 */
export const Route = createFileRoute("/_authed/staging/removal-requests")({
	beforeLoad: ({ context }) => {
	...
	component: StagingRemovalRequestsPage,
});

function StagingRemovalRequestsPage() {
	return (
		<>
			<SiteHeader title="Removal Requests" />
